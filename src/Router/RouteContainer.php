...
class RouteContainer
{
	...
	{
		$this->routes->getRouteTypeByTypeAndIndex($this->typeMethod, $this->index)->setName($name);
	}

	public function setMiddleware(array $middlewares)
	{
        $this->routes->getRouteTypeByTypeAndIndex($this->typeMethod, $this->index)->setMiddlewares($middlewares);
	}
